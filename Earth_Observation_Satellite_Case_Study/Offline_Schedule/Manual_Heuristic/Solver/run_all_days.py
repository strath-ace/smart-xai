...
while n in range(1, days):
    ...
    # plot the graphs
    manual_memory_data = manual_memory_plot(day, manual_memory, manual_memory_binary, manual_plot_image)
    constraint_land_list = solver_plot(day, solver_memory, solver_plot_image, image_mem, process_im_mem, onboard_mem, Max_pictures)
    gantt_plot(day, manual_memory_data, daily_schedule, constraint_land_list, gantt_plot_image)
    n += 1
