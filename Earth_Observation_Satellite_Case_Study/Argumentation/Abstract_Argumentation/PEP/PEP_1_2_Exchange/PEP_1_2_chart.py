...
def PEP_1_2_chart(day, filename, att_path, datastart, dataend, lines_attack_coord):

    # Chart name after saved.
    chartname = filename + '/Attack_summary_a' + str(day) + '.png'

    # Name of file after saved.
    filename1 = filename + '/Attack_summary_apc' + str(day) + '.txt'

    # Load of attacks summary information.
    attack_path_0_1 = filename + '/Attack_swap_a' + str(day) + '.txt'
    if os.path.isfile(attack_path_0_1):
        print('File ' + attack_path_0_1 + ' exists')
    else:
        print('Please run PEP file - Run_all_pep step #1' )
        print('File ' + attack_path_0_1 + ' does not exist')
        return()
