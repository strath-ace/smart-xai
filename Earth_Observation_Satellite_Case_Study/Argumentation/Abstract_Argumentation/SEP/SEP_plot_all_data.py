...
def plot_all_day(day,filename):
    # day = 3

    line_file= filename + '/line_argument_all_data' + str(day) + '.png'

    # load a1 attack file
    action_a1_path = filename + '/Attack_violation_summary_a12' + str(day) + '.txt'
    ...
    cp_path = filename + '/Optimized_Results' + str(day) + '.txt'
    ...
    z1.Pics.plot(ax=ax1, color='purple', label='Taken')
    z1.Process.plot(ax=ax1, color='cyan', label='Processed')
    z1.Dump.plot(ax=ax1, color='red', label='Down-linked')
