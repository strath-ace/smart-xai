...
df2 = pd.concat([df.sort_values('Resource', ascending=True), dc.sort_values('Resource', ascending=True), dl.sort_values('Resource', ascending=True), dj.sort_values('Resource', ascending=True)])
